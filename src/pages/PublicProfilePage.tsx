  ...
  return (
    <section className="space-y-10">
      <div>
        <Link
          to="/recipes"
          className="inline-flex items-center rounded-full bg-white px-5 py-3 font-bold text-orange-700 shadow-sm ring-1 ring-bark transition hover:bg-orange-50"
        >
          ← Retour aux recettes
        </Link>
      </div>
        ...
        <div className="grid gap-8 px-6 py-8 lg:grid-cols-[0.75fr_1.25fr] lg:px-10 lg:py-10">
          <div className="flex flex-col items-center justify-center rounded-[2rem] bg-white p-8 text-center shadow-sm ring-1 ring-bark">
            <div className="relative">
              ...
              <div className="absolute -bottom-3 -right-3 flex h-14 w-14 items-center justify-center rounded-full bg-white text-3xl shadow-sm ring-1 ring-bark">
                {currentBadge?.emoji ?? '🔒'}
              </div>
            </div>
            ...
            <div className="mt-4 rounded-[1.5rem] bg-cream-50 px-5 py-4 ring-1 ring-bark">
              {currentBadge ? (
                <>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-5 rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-bark">
              <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                ...
                <div className="shrink-0 rounded-[1.5rem] bg-cream-50 px-5 py-4 text-center ring-1 ring-bark">
      ...
      <section>
        ...
        {recipes.length === 0 ? (
          <div className="rounded-[2rem] bg-white p-8 text-center shadow-sm ring-1 ring-bark">
