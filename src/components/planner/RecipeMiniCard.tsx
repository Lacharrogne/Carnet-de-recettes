...
export default function RecipeMiniCard({
  ...
  return (
    <div className="group/card flex items-center gap-4 rounded-[1.6rem] bg-white p-4 shadow-sm ring-1 ring-bark transition hover:-translate-y-0.5 hover:shadow-md">
      <Link
